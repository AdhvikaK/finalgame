...
public class DiceRolling {
    public static void main(String[] args) {
      ...
      //this is another way of initializing valyes in an array 
      //using an algorithm
      int index = 0;
      ...
      //to the new larger value; use a for-each loop
      ...
      //Build a histogram
      final int NBINS = 10;
      //We need a count array with that number of bings
      int[] count = new int[NBINS];
      //We need to know how bug each bin is
      int binSize = NFACES/ NBINS;
      //This works well if NBINS evenly divides with NFACES
      ...
      for (int value: dieValues) {
        ...
        count[bin] = count[bin] + 1; //add 1 to the bin value belonds to
      }
